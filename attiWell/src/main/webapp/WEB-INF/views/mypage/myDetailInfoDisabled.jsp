      ...
      <table class="table">
         <tbody>
            ...
            <tr class="dot_line">
               ...
               <td>
                 <input name="member_name" type="text" size="20" value="${memberInfo.member_name.substring(0, 1)}*${memberInfo.member_name.substring(2)}"
  disabled />
                </td>
            </tr>
            <tr >
            ...
            <tr >
               ...
               <td>
                   ...
                   - <input type="text" size=4  name="tel2" value="${memberInfo.tel2 }" disabled> 
                   - <input type="text" size=4  name="tel3" value="${memberInfo.tel3 }" disabled>
               </td>
            </tr>
            <tr >
               ...
               <td>
                ...
                <c:choose> 
                  <c:when test="${memberInfo.smssts_yn=='true' }">
                    <input type="checkbox"  name="smssts_yn" value="Y" checked disabled/> 쇼핑몰에서 발송하는 SMS 소식을 수신합니다.
                  </c:when>
                  <c:otherwise>
            ...
            <tr >
               ...
               <td>
                  <input type="text" name="email1" size=10 value="${member_info.email1 }" disabled/> @ <input type="text" size=10  name="email2" value="${memberInfo.email2 }" disabled/> 
      ...
      <div class="clear"  style="text-align:center">
         ...
         <table align=center>
            <tr >
               <button type="button" class="btn btn-secondary" onclick="goModifyPage()" style="margin-right:10px; text-align:center">수정하기</button>
               <button type="button" class="btn btn-secondary" onclick="goBack()" >이전으로</button>
            </tr>
         </table>
      </div>
