            ...
            <table class="table">
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><input type="button" class="btn btn-secondary"
                        value="수정하기"
                        onClick="fn_modify_member_info('${memberInfo.member_pw }','member_pw')" />
                     </td>
                  </tr>
                  <tr class="dot_line">
                  ...
                  <input type="radio" name="member_gender" value="101"
                     ...
                     <td><input type="button" class="btn btn-secondary"
                        value="수정하기"
                        onClick="fn_modify_member_info('${memberInfo.member_gender}','member_gender')" />
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td><input type="button" class="btn btn-secondary"
                        value="수정하기"
                        onClick="fn_modify_member_info('${memberInfo.member_id }','tel')" />
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td><input type="text" id="zipcode" name="zipcode" size=5
                        ...
                        <p>
                           ...
                           <input type="text" id="roadAddress" name="roadAddress"
                              size="50" value="${memberInfo.roadAddress }"><br>
            ...
            <table align=center>
               <tr>
                  <td><input type="hidden" name="command"
                     ...
                     type="button" class="btn btn-secondary" value="이전으로" onclick="goBack()"></td>
               </tr>
            </table>
         </div>
