					...
					<tr>
						<form name="frm_order_all_cart">
							<c:forEach var="item" items="${myGoodsList }" varStatus="cnt">
								...
								<td class="price"><span
									style="text-decoration: line-through;">${item.goods_price }원</span></td>
								<td><strong> <c:set var="goodsPrice"
										...
										<%
											double roundedDiscount = Math
																.ceil(Double.parseDouble(pageContext.getAttribute("discount").toString()));
										...
										%> <fmt:formatNumber value="${discountedPrice}" type="number"
											...
											<c:choose>
												<c:when
													test="${item.goods_price == item.goods_sales_price }">
								...
								<td><input type="text" id="cart_goods_qty"
									...
									<!--   select_goods_qty --> <input type="hidden"
									id="select_goods_qty" name="select_goods_qty"
									value="${cart_goods_qty}"> <a
								...
								</strong> <input type="hidden" id="h_discounted_price"
									value="${item.goods_sales_price*0.9*cart_goods_qty}"></td>

								<td><a
									href="javascript:fn_order_each_goods('${item.goods_id }','${item.goods_title }','${item.goods_sales_price}','${item.goods_fileName}');"
									style="margin-bottom: 10px;">
										<button type="button"
											style="background-color: #1b7340; border: #1b7340"
											class="btn btn-primary btn-sm">주문하기</button>
								</a> <a href="javascript:delete_cart_goods('${cart_id}');"
									style="margin-bottom: 10px;">
